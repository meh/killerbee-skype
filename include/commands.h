...
#ifndef _BITLBEE_SKYPE_COMMANDS
#define _BITLBEE_SKYPE_COMMANDS

#include "common.h"

char* Skype_cmd_display_name (set_t* set, char* value);

char* Skype_cmd_call (set_t* set, char* value);

char* Skype_cmd_balance (set_t* set, char* value);

char* Skype_cmd_search (set_t* set, char* value);
